    ...
    <div className="mt-8 space-y-6 border-t border-gray-200 pt-8 animate-fadeIn">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Based on your system size and energy consumption.
          </p>
        </div>
        <div className="flex items-center gap-3">
          <span className="text-sm font-medium text-gray-500">Risk Band:</span>
          <span
            data-testid="quote-result-risk-band"
            className={`px-3 py-1 text-sm font-bold border rounded-full ${bandStyles[riskBand]}`}
          >
            Band {riskBand}
          </span>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
          ...
          <span
            ...
            data-testid="quote-result-system-price"
          >
        ...
        <div className="bg-gray-50 p-4 rounded-lg border border-gray-100">
          ...
          <span
            className="text-2xl font-bold text-gray-900"
            data-testid="quote-result-principal-amount"
          >
            {new Intl.NumberFormat('de-DE', {
              style: 'currency',
              currency: 'EUR',
      ...
      <div>
        ...
        <div
          ...
          data-testid="quote-result-offers"
        >
          {offers.map((offer) => (
            <div
              key={offer.termYears}

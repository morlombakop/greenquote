    ...
    <div className="min-h-screen bg-slate-50 flex flex-col justify-between font-sans text-slate-900">
      ...
      <main className="flex-grow flex items-center justify-center py-12 px-4">
        <div className="max-w-3xl text-center space-y-8">
          ...
          <p className="text-lg sm:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
            Calculate your residential solar system pricing, assess your risk band profiles, and receive instant personalized installment plans tailored to your consumption metrics.
          </p>
          ...
          <div className="pt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 text-left max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
              <div className="text-emerald-600 text-xl font-bold mb-2">01. Instant Pricing</div>
              <p className="text-slate-600 text-sm">Get transparent, dynamic system pricing computations scaled directly to your exact generation requirements.</p>
            </div>
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
              <div className="text-emerald-600 text-xl font-bold mb-2">02. Risk Assessment</div>
              <p className="text-slate-600 text-sm">Automated system classification places requests instantly into optimized risk profiles for transparent qualification.</p>
            </div>
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
              <div className="text-emerald-600 text-xl font-bold mb-2">03. Tailored Terms</div>
              <p className="text-slate-600 text-sm">Review split structural payment options covering competitive 5, 10, and 15-year fully amortized terms.</p>
            </div>
          </div>
        </div>
      </main>
      ...
      <footer className="bg-white border-t border-slate-200 py-6 text-center text-xs text-slate-400">
        <div className="max-w-6xl mx-auto px-4">
          &copy; {new Date().getFullYear()} GreenQuote. All rights reserved. Built for Cloover Engineering Challenge.
        </div>
      </footer>
    </div>
  );
